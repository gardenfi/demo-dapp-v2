...
var Block = class {
   ...
   */
  toJSON() {
    const { baseFeePerGas, difficulty, extraData, gasLimit, gasUsed, hash: hash3, miner, nonce, number: number3, parentHash, timestamp, transactions } = this;
    return {
      _type: "Block",
...
var TransactionResponse = class _TransactionResponse {
   ...
   */
  toJSON() {
    const { blockNumber, blockHash, index, hash: hash3, type, to, from, nonce, data, signature, accessList } = this;
    return {
      _type: "TransactionReceipt",
      accessList,
      blockNumber,
